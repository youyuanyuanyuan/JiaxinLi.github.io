...
![Calendar Cover](calendarcover.jpg)
![Calendar Content](calendarcontent.GIF)
![Paper Folding](paperfolding.GIF)
...
## written reflection/self-assessment (required)

Strength 
` completed my concept and all three little goals
` no waste, recycable 
` altar's modern form

Weakness
` some users may want to control which day the practice appears, but that is not available in this version
` target audience not very specific (but it hard to locate specific target audience as I am looking for people have deeper relationship with their lost love one and it can not be defined by gender, age or anything like that) 

self-assessment grade
{24 points (Concepting 6 + Research 6 + Prototyping 12)}:
